...
- Escala las instancias EC2 cuando el CPU es mayor al 80$
...
## Opcional: Obtener id's y IP privada de la vm en ejecución
```vim
LAB_NAME=<LAB_NAME>
...
- Validar el contenedor corriendo la aplicación web: sudo docker ps
