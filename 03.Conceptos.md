...
## 4.1 Validar el estado de Terraform

```vim
terraform apply
```
Terraform compara su estado local contra el estado de la infraestructura.
...
# 7. Cambiar el contenido del archivo
# 8. Aplicar Terraform
Cómo el archivo fue cambiado, ahora es diferente del estado de Terraform

Aplica cambios.

# 9. Destruir el archivo
