...
## Crear archivo data.tf y agregar un recurso local_file para administrar la llave
```tf
data "local_file" "pgp_key" {
  filename = "terrafrom.gpg"
}
```
...
## 13. Configurar el nuevo usuario de AWS, plan y aplicar.
...
## 16. Opcional: Crear el archivo main.tf
...
## 17. Opcional: Agregar items a la tabla
```vim
